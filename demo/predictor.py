...
def get_clip_embeddings(vocabulary, prompt='a '):
    from clusterdet.modeling.text_encoder.text_encoder import build_text_encoder
...
BUILDIN_CLASSIFIER = {
    'pascal_part': 'datasets/metadata/pascal_part_clip_a+cname.npy',
    'partimagenet': 'datasets/metadata/partimagenet_clip_a+cnamefix.npy',
    ...
    'voc': 'datasets/metadata/voc_clip_a+cname.npy',
}
