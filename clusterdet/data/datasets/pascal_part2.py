...
PASCAL_PART_BASE_CATEGORIES = [
    ...
    {"id": 67, "name": "pottedplant:plant"},
    {"id": 68, "name": "pottedplant:pot"},
...
def register_pascal_part2_instances(name, metadata, json_file, image_root):
...
_PASCAL_PART = {
    "pascal_part_base2_train": ("pascal_part/VOCdevkit/VOC2010/JPEGImages", "pascal_part/train_base2.json"),
}


def register_all_pascal_part2(root):
    for key, (image_root, json_file) in _PASCAL_PART.items():
        register_pascal_part2_instances(
            key,
...
register_all_pascal_part2(_root)
