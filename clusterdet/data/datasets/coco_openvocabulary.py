...
# ==== Predefined datasets and splits for COCO Zero-Shot==========

_PREDEFINED_SPLITS_COCO_ZEROSHOT = {
...
def register_all_coco_zeroshot(root):
    for key, (image_root, json_file, cat) in _PREDEFINED_SPLITS_COCO_ZEROSHOT.items():
...
_CUSTOM_SPLITS_COCO_CAPTION = {
    # "cc3m_coco_train_tags": ("cc3m/training/", "cc3m/coco_train_image_info_tags.json"),
    # "coco_caption_train": ("coco/train2017/", "coco/zero-shot/coco_caption_train_image_info.json"),
    "coco_caption_train_tags": ("coco/train2017/", "coco/zero-shot/captions_train2017_tags_allcaps.json"),
    "coco_caption_train_4764nouns": ("coco/train2017", "coco/zero-shot/captions_train2017_4764nouns.json"),
}

def register_all_coco_caption(root):
    for key, (image_root, json_file) in _CUSTOM_SPLITS_COCO_CAPTION.items():
...
register_all_coco_caption(_root)
