...
import os
'''
Import from https://github.com/facebookresearch/Detic/blob/main/detic/data/datasets/objects365.py
...
_PREDEFINED_SPLITS_OBJECTS365 = {
    ...
    "objects365_v1_train": ("objects365/train", "objects365/annotations/zhiyuan_objv1_train_fixname_fixmiss.json"),
    "objects365_v1_val": ("objects365/val", "objects365/annotations/zhiyuan_objv1_val_fixname.json"),
    # v2_val: 80,000 images, 1,240,587 annotations
    # v1_val: 30,310 images, 502,231 annotations
