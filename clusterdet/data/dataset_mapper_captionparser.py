...
logger = logging.getLogger('detectron2.clusterdet.data.dataset_mapper_captionparser')


class DatasetMapperCaptionParser(DatasetMapper):
    @configurable
    def __init__(self, is_train: bool,
        ...
        **kwargs):
        ...
        self.caption_parser = caption_parser
    ...
    def from_config(cls, cfg, is_train: bool = True):
        ...
        ret['caption_parser'] = sng_parser.Parser()
        return ret
    ...
    def __call__(self, dataset_dict):
        ...
        if 'captions' in dataset_dict:
            nouns = []
            for cap in dataset_dict['captions']:
                parser_res = self.caption_parser.parse(cap)
                for noun_dict in parser_res['entities']:
                    noun = noun_dict['head']
                    if noun not in nouns:
                        nouns.append(noun_dict['head'])
