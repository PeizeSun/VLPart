...
class PACOEvaluator(LVISEvaluator):
    ...
    def __init__(
        ...
        *,
        ...
        self._logger = logging.getLogger('detectron2.clusterdet.evaluation.paco_evaluation')
...
def _evaluate_predictions_on_lvis(
    ...
    logger = logging.getLogger('detectron2.clusterdet.evaluation.paco_evaluation')
